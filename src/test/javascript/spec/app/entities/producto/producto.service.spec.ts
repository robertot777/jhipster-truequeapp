...
import { IProducto, Producto, TipoOferta } from 'app/shared/model/producto.model';
...
describe('Service Tests', () => {
    describe('Producto Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Producto(0, currentDate, 'AAAAAAA', TipoOferta.ALIMENTACION, 'AAAAAAA', 0);
        });
