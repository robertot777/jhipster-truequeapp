...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Producto.class.getName() + ".imagenProductos", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Imagen.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Trueque.class.getName(), jcacheConfiguration);
